  ...
  return (
    <ConfigProvider locale={zhCN}>
      ...
      <div className="container">
        <Form
          model={model}
          writeDefaultValueToModel="force"
        ...
        >
          ...
          />
          <FormItem component="slider" defaultValue={80} label="进度条" name="slider" required />
          <FormItem component="switch" defaultValue={true} label="开关" name="switch" required />
          <FormItem
